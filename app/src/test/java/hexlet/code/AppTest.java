...
class AppTest {
    ...
    void callNonFormatJson() throws Exception {
        ...
        String actual = Differ.generate("fixtures/filepath1.json", "fixtures/filepath2.json");
    ...
    void callNonFormatYaml() throws Exception {
        ...
        String actual = Differ.generate("fixtures/filepath1.yaml", "fixtures/filepath2.yaml");
        assertEquals(expected.trim(), actual.trim());
    }
    ...
    void callYaml() throws Exception {
        ...
        String actual = Differ.generate("fixtures/filepath1.yaml", "fixtures/filepath2.yaml", "json");
        assertEquals(expected.trim(), actual.trim());
    }
    ...
    void callYamlPlain() throws Exception {
        ...
        String actual = Differ.generate("fixtures/filepath1.yaml", "fixtures/filepath2.yaml", "plain");
        assertEquals(expected.trim(), actual.trim());
    }
    ...
    void callYamlStylish() throws Exception {
        String expected = exceptedYamlTest;
        String actual = Differ.generate("fixtures/filepath1.yaml", "fixtures/filepath2.yaml", "stylish");
        assertEquals(expected.trim(), actual.trim());
    }
    ...
    void callPlainJson() throws Exception {
        ...
        String actual = Differ.generate("fixtures/filepath1.json", "fixtures/filepath2.json", "plain");
        assertEquals(expected.trim(), actual.trim());
    }
    ...
    void callJsonJson() throws Exception {
        ...
        String actual = Differ.generate("fixtures/filepath1.json", "fixtures/filepath2.json", "json");
        assertEquals(expected.trim(), actual.trim());
    }
    ...
    void callStylishJson() throws Exception {
        String expected = exceptedDefault;
        String actual = Differ.generate("fixtures/filepath1.json", "fixtures/filepath2.json", "stylish");
        assertEquals(expected.trim(), actual.trim());
    }
